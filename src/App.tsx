        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
            ...
            >
              <img
                src={pyramidImg}
                alt="Iridescent 3D metallic pyramid"
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-12">
        <FadeUp>
          <p className={`text-2xl md:text-3xl text-center leading-snug font-medium transition-colors duration-500 ${dark ? 'text-white/60' : 'text-[#1A1A1A]/70'}`}>
            We believe the best games are the ones played{' '}
            <strong className={dark ? 'text-white' : 'text-[#1A1A1A]'}>together</strong>.
            Joe Yoke is a platform built for{' '}
            <strong className={dark ? 'text-white' : 'text-[#1A1A1A]'}>real connections</strong>{' '}
            — where every match is a chance to meet someone new, sharpen your skills, and{' '}
            <strong className={dark ? 'text-white' : 'text-[#1A1A1A]'}>build a crew</strong> you can count on.
          </p>
        </FadeUp>
...
function GameCard({ game, delay }: { game: Game; delay: number; dark: boolean }) {
  return (
    <FadeUp delay={delay}>
      <div className="group relative rounded-3xl overflow-hidden border border-white/8 hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl hover:shadow-black/50" style={{ minHeight: 320 }}>
        ...
        <div className="absolute top-4 left-4 right-4 flex items-start justify-between z-10">
          <span className="px-3 py-1 rounded-full bg-black/50 backdrop-blur-sm text-white/70 text-xs font-medium tracking-widest uppercase">
            {game.badge}
          </span>
        ...
        >
          {/* Stacked blur layers that feather from 0 → full, matching the gradient above */}
          ...
          <a href="#" className="relative group/link inline-flex items-center gap-1.5 text-[#C5FF00] text-sm font-semibold tracking-wide hover:gap-3 transition-all duration-200 mt-1">
      ...
      <div className="max-w-7xl mx-auto">
        <FadeUp>
          <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
            ...
            <button className={`group flex items-center gap-2 text-sm font-semibold transition-colors ${dark ? 'text-white/40 hover:text-white' : 'text-[#1A1A1A]/50 hover:text-[#1A1A1A]'}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {GAMES.map((game, i) => (
            <GameCard key={game.id} game={game} delay={i * 0.08} dark={dark} />
          ))}
        </div>
      </div>
    </section>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-14">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter leading-none">
                  Millions of players<br />Endless ways to connect.
                </h2>
              </div>
    ...
    <footer id="download" className={`pt-20 pb-0 px-6 md:px-12 overflow-hidden transition-colors duration-500 ${dark ? 'bg-[#050505]' : 'bg-[#0A0A0A]'}`}>
      <div className="max-w-7xl mx-auto">
        <FadeUp>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-16 border-b border-white/10">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white tracking-tighter leading-none max-w-2xl">
              ...
              <span className="text-[#C5FF00]">Let&apos;s play.</span>
            </h2>
        ...
        <div className="flex items-center py-6 text-xs text-white/20">
          <span>© 2026 Joe Yoke. All rights reserved.</span>
        </div>
      </div>
